...
public class AsteroidSpawner : MonoBehaviour {
	...
	void Update () {
        ...
        while (nextSpawn < 0) {
            ...
            var v1 = new Vector3(Mathf.Cos(t1)*Mathf.Cos(t2), Mathf.Sin(t1)*Mathf.Cos(t2), Mathf.Sin(t2))*1000;
            ...
            r.velocity = new Vector3(Random.Range(-1f, 1f), Random.Range(-1f, 1f), Random.Range(-1f, 1f)) + Ship.rigidbody.velocity;
